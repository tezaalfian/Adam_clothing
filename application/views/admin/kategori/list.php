    ...
    <section class="content container-fluid">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?= base_url('admin/kategori/add') ?>" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Tambah Baru</a>
              ...
              <?php $no = 1; ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" data-toggle="modal" data-target="#modal-hapus" nilai="<?= $key['id_kategori'] ?>" class="btn btn-danger hapus"><i class="fa fa-trash"></i></button>
                  </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
  ...
  <div class="modal fade" id="modal-hapus">
    ...
    <script type="text/javascript">
      ...
      $('.hapus').click(function(){
        ...
        $('.delete').attr('href', '<?= base_url('admin/kategori/delete/') ?>'+kode);
      });
    </script>
</body>
</html>