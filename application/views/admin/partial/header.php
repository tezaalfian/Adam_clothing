<header class="main-header">
    ...
    <!-- Logo -->
	    <a href="index2.html" class="logo">
	      ...
	      <span class="logo-mini">ADC</span>
	      <!-- logo for regular state and mobile devices -->
	      <span class="logo-lg"><b>Adam</b>Clothing</span>
	    </a>
	        ...
	        <ul class="nav navbar-nav">
	          ...
	          <li class="dropdown user user-menu">
	            ...
	            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
	              ...
	              <img src="<?= base_url('upload/users/'.$user['foto']) ?>" class="user-image" alt="User Image">
	            ...
	            <ul class="dropdown-menu">
	              ...
	              <li class="user-header">
	                <img src="<?= base_url('upload/users/'.$user['foto']) ?>" class="img-circle" alt="User Image">
