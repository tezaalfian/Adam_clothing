    ...
    <section class="content container-fluid">
      <div class="box box-primary">
        ...
        <div class="box-body" style="">
            ...
            <div class="row">
                <form class="form-horizontal" method="post" action="<?= base_url('admin/produk/edit/'.$produk['id_produk']) ?>" enctype="multipart/form-data">
                <div class="col-md-6">
                    <div class="form-group <?php echo form_error('kategori') ? 'has-error':'' ?>">
                        ...
                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="kategori">
                            <?php foreach ($kategori as $key) : ?>
                                <option value="<?= $key['id_kategori'] ?>" <?= $key['id_kategori'] == $produk['kategori_id'] ? "selected ='selected'": '' ?>><?= $key['nama_kategori'] ?> | <?= substr($key['deskripsi'],0,30) ?>....</option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <img class="profile-user-img img-circle" src="<?= base_url('upload/produk/'.$produk['foto']) ?>">
